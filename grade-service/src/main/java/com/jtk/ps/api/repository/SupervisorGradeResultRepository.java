...
public interface SupervisorGradeResultRepository extends JpaRepository<SupervisorGradeResult,Integer>{
    ...
    Optional<SupervisorGradeResult> findBySupervisorGradeAspectAndSupervisorGrade_ParticipantAndSupervisorGrade_Phase(SupervisorGradeAspect supervisorGradeAspect, Participant participant, Integer phase);
